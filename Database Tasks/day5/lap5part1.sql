...
-- 3.	Display student with the following Format (use isNull function) immmmppppppppppp
...
-- 13.	Select Student first name and the data of his supervisor   immmppppppppppppp
SELECT y.St_Fname [Student First Name], X.*
